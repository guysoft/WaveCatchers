...
file1 = os.path.join(path, "dataset", "dataset1", "all_down", "chunk827-164.55225.wav") # 'Violin-up-down\\all_down\\'
file2 = os.path.join(path, "dataset", "dataset1", "all_up", "chunk380-164.55225.wav") # 'Violin-up-down\\all_down\\'
